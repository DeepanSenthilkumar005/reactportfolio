...
function AboutPage() {
  return (
    <section id='About' data-aos='fade-up' className='AboutPage dark:text-white justify-items-center w-full md:min:h-full p-4'>
      ...
      <div className="Content shadow-lg cursor-pointer text-justify text-2xl stm:text-lg h-fit md:w-2/3  rounded-lg font-medium border  border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 p-4">
