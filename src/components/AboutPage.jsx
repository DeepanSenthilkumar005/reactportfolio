...
function AboutPage() {
  return (
    <section className='AboutPage justify-items-center w-full md:min:h-full p-4'>
      <div className="Heading text-2xl stm:text-xxl font-semibold text-center m-2">
        My Introduction
      </div>
      <div className="Content text-justify stm:text-center text-xl h-fit md:w-2/3  rounded-lg font-medium border border-gray-700  p-4">
...
With expertise in multiple programming languages, I am cooperative and passionate about delivering high-quality software products. My goal is to bring visions to life through creativity, technology, and precision.
      ...
      <div className="Resume w-full mt-4 justify-items-center">
        <div className="border border-blue-400 p-3 rounded-l-xl rounded-r-xl hover:bg-blue-400 cursor-pointer hover:text-white">
